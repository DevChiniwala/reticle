 ...
 *
 * `telemetry.ts` is the wire contract; this is the taxonomy the no-session DIAGNOSIS owns, read by
 * `explainNoSession`, the session manager and the refusal reporter alike.
 *
